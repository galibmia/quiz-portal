...
${storage?`<div class="mt-5">
      <h1 class="text-center">Previous Submissions <button class="text-blue-800 text-xs" onclick="localStorage.clear(); localStorage.reload()">Clear History</button></h1>
    <div
    ...
    ${storage
      ?.reverse()
      ?.map(
        (item) => `<div class="flex justify-between items-center border rounded p-2 my-2 shadow-sm">
